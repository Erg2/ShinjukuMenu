...
# list of pages
pageList = ["https://www.shinjukustationvt.com", ]
...
try:
    ...
    print("Scroll pageHeight", pageHeight)
    ...
    while True:
        ...
        for menu in menuList:
            ...
            scrollCmd = "window.scrollTo({top:" + str(topOffset) +"})"     # Jump to top of page
            ...
            if winHeight < menuHeight + menuOffset:
                ...
                for ln in range(topOffset, (menuHeight + menuOffset) - winHeight, 1):
                    ...
                    scrollCmd = "window.scrollTo({top:" + str(ln) + "})"
                    driver.execute_script(scrollCmd)
